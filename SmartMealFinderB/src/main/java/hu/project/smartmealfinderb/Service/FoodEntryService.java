...
public interface FoodEntryService {
    void addFoodEntry(User user, DailyProgress dailyProgress, Long spoonacularId, String name, String category, double quantity, String unit, double calories, double protein, double carbs, double fats);
